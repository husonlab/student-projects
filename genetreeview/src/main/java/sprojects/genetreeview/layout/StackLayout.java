/*
 *  StackLayout.java Copyright (C) 2024 Algorithms in Bioinformatics
 *
...
public class StackLayout extends MultipleFramesLayout {
	...
	private void transformNode(Node node, double x) {
		...
		else if (transformedSnapshots != null && transformedSnapshots.contains(node))
			index = transformedSnapshots.indexOf(node);
